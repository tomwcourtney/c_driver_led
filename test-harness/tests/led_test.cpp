...
// this test is made irrelevant by changing how registration works. you can't register
// an LED with the same ID twice because the user doesn't choose the ID anymore
